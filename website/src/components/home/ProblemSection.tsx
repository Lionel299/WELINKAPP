  ...
  return (
    <section className="py-20 md:py-32 bg-gray-50 relative overflow-hidden">
      ...
      <Container className="relative z-10">
        ...
        <div className="problem-cards-grid grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mt-16">
          {problemsList.map((problem: any, index: number) => (
            <div key={index} className="problem-card relative">
              <div className="bg-white rounded-2xl p-6 border border-gray-100 shadow-sm hover:shadow-md transition-shadow relative overflow-hidden group h-full">
                <div className="w-12 h-12 flex items-center justify-center mb-6 relative z-10">
                  <img
                    src="/logo-size.png"
                    alt=""
                    aria-hidden="true"
                    className="h-11 w-11 object-contain logo-red"
                  />
                </div>
